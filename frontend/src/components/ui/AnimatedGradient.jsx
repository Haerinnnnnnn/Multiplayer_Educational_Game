...
import { WebGLErrorBoundary, WebGLFallback } from './WebGLErrorBoundary.jsx';
...
export function AnimatedGradient({
  ...
  useEffect(() => {
    ...
    try {
      ...
      function animate(time) {
        ...
        const color1 = hexToRgba(params.color1);
        const color2 = hexToRgba(params.color2);
        const color3 = hexToRgba(params.color3);
      ...
      console.warn('Animated gradient WebGL error:', error);
      setHasWebGLError(true);
      return undefined;
    }
  ...
  if (hasWebGLError) {
    return <WebGLFallback className={className} style={{ borderRadius: radius, ...style }} />;
  }

  return (
    <WebGLErrorBoundary
      fallback={<WebGLFallback className={className} style={{ borderRadius: radius, ...style }} />}
    >
      <div
        ref={containerRef}
        className={className}
